...
OUT_FILE_BAM="${8}"
OUT_FILE_BASE_FREQS="${9}"
OUT_FILE_BASE_FREQS_GLOB="${10}"
OUT_FILE_DEDUP_STATS="${11}"
OUT_FILE_INSERT_SIZE="${12}"
OUT_FILE_PRE_DEDUP="${13}"
OUT_FILE_CONSENSUS="${14}"
OUT_FILE_CONSENSUS_GLOB="${15}"
OUT_FILE_COORDS="${16}"
OUT_FILE_REF_FASTA="${17}"
OUT_FILE_REF_FASTA_FAI="${18}"
OUT_FILE_BLAST="${19}"
OUT_FILE_SHIVER_CONTIGS="${20}"
REF_STEM_FILE="${21}"
LOG="${22}"
...
${OUT_FILE_BLAST} ${REF_STEM_FILE} ${IN_FILE_CLEAN_READS_FWD} ${IN_FILE_CLEAN_READS_BWD} 2>&1"
